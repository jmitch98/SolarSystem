...
Shader::Shader(const char* vertexFile, const char* fragmentFile) {
  ...
  if (!success) {
    ...
    std::cout << "Could not compile vertex shader: " << log << std::endl;
  }
  ...
  if (!success) {
    ...
    std::cout << "Could not compile fragment shader: " << log << std::endl;
  }
...
void Shader::useProgram() { glUseProgram(this->id); }
}  // namespace renderer
